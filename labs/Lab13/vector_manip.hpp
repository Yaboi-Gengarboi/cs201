...
//REQUIRED
//Print the words of a string vector by reference and seperated
//by spaces using a range-based for-loop.
//@param strVec vector of strings to print
